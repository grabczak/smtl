...
getStatement :: Program -> Int -> Maybe Statement
...
testParseAddition = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getAddOperands (getExpr expr) of
...
testParseSubtraction = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getSubOperands (getExpr expr) of
...
testParseMultiplication = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getMulOperands (getExpr expr) of
...
testParseNegation = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getNegOperand (getExpr expr) of
...
testParseEquality = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getEqOperands (getExpr expr) of
...
testParseInequality = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getNeqOperands (getExpr expr) of
...
testParseLessThan = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getLtOperands (getExpr expr) of
...
testParseGreaterThan = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getGtOperands (getExpr expr) of
...
testParseLessEqual = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getLeqOperands (getExpr expr) of
...
testParseGreaterEqual = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getGeqOperands (getExpr expr) of
...
testParseAnd = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getAndOperands (getExpr expr) of
...
testParseOr = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getOrOperands (getExpr expr) of
...
testParseNot = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getNotOperand (getExpr expr) of
...
testParseImplies = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getImpliesOperands (getExpr expr) of
...
testParseIff = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assign _ expr) -> case getIffOperands (getExpr expr) of
...
testParseAssertComparison = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assert expr) -> case getGeqOperands (getExpr expr) of
...
testParseAssertLogical = TestCase $ do
  ...
  case parseProgram "test" input of
    Left err -> assertFailure $ "Failed to parse: " ++ errorBundlePretty err
    Right prog -> case getStatement prog 0 of
      Just (Assert expr) -> case getAndOperands (getExpr expr) of
...
testParseCompleteProgram = TestCase $ do
  ...
  case parseProgram "test" input of
    ...
    Right prog -> do
      case getStatement prog 0 of
        Just (Declare _ _) -> return ()
        _ -> assertFailure "Expected Declare statement"
      case getStatement prog 1 of
        Just (Assign _ _) -> return ()
        _ -> assertFailure "Expected Assign statement"
      case getStatement prog 2 of
        Just (Assert _) -> assertBool "Complete program parsed" True
        _ -> assertFailure "Expected Assert statement"
...
testParseProductionExample = TestCase $ do
  ...
  case parseProgram "test" input of
    ...
    Right prog -> do
      ...
      case getStatement prog 1 of
        Just (Assign _ _) -> assertBool "Production example parsed" True
